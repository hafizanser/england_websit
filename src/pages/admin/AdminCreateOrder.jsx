...
export default function AdminCreateOrder() {
  ...
  // Order can be placed once there is at least one item (customer details are no
  // longer captured on this screen).
  const canSubmit = lines.length > 0
  const placeHint = lines.length === 0 ? 'Kam az kam 1 item chahiye' : ''
