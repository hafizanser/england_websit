...
/**
 * Order-level profit analytics in the shared order_system database. Port of
 * Models\RefProfit — mirrors the order_management Laravel profit logic:
 *   per-line cost = cotton ? production_cotton_price : box ? production_box_price : NULL
 *   line_profit   = cost IS NULL ? 0 : quantity * (sale_price - cost)
 */
class ProfitRepo extends BaseRepo
{
