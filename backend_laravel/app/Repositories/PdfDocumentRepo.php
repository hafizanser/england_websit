...
/** PDF documents — CRUD for the PDF Catalog. */
class PdfDocumentRepo extends BaseRepo
{
    /** All documents (admin view), in order. */
    public function all(): array
    {
        return array_map(
            [$this, 'decorate'],
            $this->select('SELECT * FROM pdf_documents ORDER BY position ASC, id ASC')
        );
    }
